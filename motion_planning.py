...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        self.set_home_position(global_home_position['lon0'], global_home_position['lat0'], 0)
        ...
        #grid_goal = (-north_offset + 422, -east_offset + 530)
        # TODO: adapt to set goal as latitude / longitude position and convert
        goal_possible = False
        while not goal_possible:
            converage_radius = 200
            random_goal_coordinate = local_to_global([local_position[0]+random.uniform(-converage_radius, converage_radius),
                            local_position[1]+random.uniform(-converage_radius, converage_radius), 0.0], self.global_home)
            ...
            goal_possible = grid[grid_goal[0]][grid_goal[1]] != 1
        
        print('global goal position {}'.format(goal_position))
        
        
        # Run A* to find a path from start to goal
        # TODO: add diagonal motions with a cost of sqrt(2) to your A* implementation: Refer to planning_utils.py
        ...
        def collinearity_prune(p1, p2, p3): 
        ...
        if len(path) >= 3:
            ...
            i = 2
            while i < (len(path) - 1):
                while collinearity_prune(p1,p2,p3) and (i < len(path)-2):
                    i += 1
                    p2 = p3
                    p3 = path[i]
